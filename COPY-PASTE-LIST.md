# ByteBazaar - A Modern Fullstack E-Commerce Marketplace for Digital Products

Built with the Next.js 14 App Router, tRPC, TypeScript, Payload & Tailwind

![Project Image](https://github.com/joschan21/ByteBazaar/blob/master/public/thumbnail.jpg)
...
try {
    ...
    from: 'ByteBazaar <hello@joshtriedcoding.com>',
    to: [user.email],
...
<Html>
    <Head />
    <Preview>Your ByteBazaar Receipt</Preview>
    ...
    <Container style={container}>
        ...
        Copyright © 2023 ByteBazaar Inc. <br />{' '}
...
<Body style={main}>
    ...
    <Text style={paragraph}>
        Welcome to ByteBazaar, the marketplace for high quality digital
...
export function constructMetadata({
  title = 'ByteBazaar - the marketplace for digital assets',
  description = 'ByteBazaar is an open-source marketplace for high-quality digital goods.',
  image = '/thumbnail.png',
  icons = '/favicon.ico',
  noIndex = false,
}: {
  ...
  return {
    ...
    icons,
    metadataBase: new URL('https://ByteBazaar.up.railway.app'),
    ...(noIndex && {
      robots: {
        index: false,
        follow: false,
